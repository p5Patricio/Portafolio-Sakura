...
function SobreMi() {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 bg-[url('/src/assets/scroll-02-furin.png')] bg-cover bg-center bg-no-repeat"
      />

      {/* Content */}
      <div className="relative z-20 w-full px-6 py-32 md:py-36 lg:py-40 md:px-12 lg:px-24 flex flex-col items-center">
        ...
        <div className="max-w-3xl mt-12 text-center space-y-6">
          <p className="text-color-tinta/90 leading-relaxed">{t.sobreMi.para1}</p>
          <p className="text-color-tinta/90 leading-relaxed">{t.sobreMi.para2}</p>
        </div>
